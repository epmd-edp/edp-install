...
Mandatory parameters: 
 ```   
    ...
    - jenkins-operator.jenkins.pullSecrets                               #;
    - jenkins-operator.jenkins.basePath                               # ;
    ...
    - sonar-operator.sonar.image                                   # Image for Sonar. The image can be found on [Dockerhub] (https://hub.docker.com/_/sonarqube);
    - sonar-operator.sonar.version                                 # Sonar version. The released version can be found on [Dockerhub](https://hub.docker.com/_/sonarqube/?tab=tags);
    ...
    - admin-console-operator.adminConsole.pullSecrets                                  # ;
