...
* Install EDP in the <edp-project> project with the helm command. Depending on the cloud provider, the parameter values may differ, make sure that the set values​are correct for your provider. 
