...
* Keycloak v.[11.0.2](https://https://www.keycloak.org/docs/latest/release_notes/index.html#keycloak-11-0-0) should 
...
>_**NOTE**: EDP team is using a helm chart from the [codecentric](https://https://github.com/codecentric/helm-charts/tree/master/charts/keycloak) 
...
autoscaling, monitoring, etc.), for details, please refer to the [Official Chart Documentation](https://https://github.com/codecentric/helm-charts/tree/master/charts/keycloak). 
